    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="<?php echo base_url('Standard'); ?>">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Barang">
          ...
          <ul class="sidenav-second-level collapse" id="collapseBarang">
            <li>
              <a href="<?php echo base_url('Barang/out') ?>"><i class="fa fa-fw fa-cube"></i> Ambil Barang</a>
            </li>
            <li>
              <a href="<?php echo base_url('Barang/supply') ?>"><i class="fa fa-fw fa-list"></i> Supply Barang</a>
            </li>
          </ul>
        </li>        
      </ul>
