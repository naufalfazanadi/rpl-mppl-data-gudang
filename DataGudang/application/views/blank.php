...
<body class="bg-dark">
  <div class="container" style="margin-top: 30px">
    ...
    <div class="card card-login mx-auto mt-5">
      <div class="card-header" align="center">Invalid Access</div>
      <div class="card-body">
        <div class="alert alert-danger" role="alert">
          <h6>Maaf kamu tidak dapat mengakses halaman ini, halaman ini hanya dapat diakses oleh admin</h6>
        </div>
        <h6>Silahkan logout kemudian login kembali dengan akun admin</h6>
        <div align="center">
          <a href="
          <?php 
